...
var InstallmentSecuredPlan_1 = require("../payments/types/InstallmentSecuredPlan");
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .get(apiURL.URL_TYPE_INSTALLMENT_SECURED_PLANS + "/?amount=" + amount + "&currency=" + currency + "&effectiveInterest=" + effectiveInterestRate + "&orderDate=" + orderDate, paymentService.getUnzer().getPrivateKey())
                ...
                case 1:
                    ...
                    response.entity.map(function (item) {
                        ...
                        var installmentSecuredPlan = new InstallmentSecuredPlan_1.default();
...
//# sourceMappingURL=FetchInstallmentSecuredPlan.js.map