...
exports.default = (function (installmentSecuredId, args, paymentService) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .put(apiURL.URL_TYPE_INSTALLMENT_SECURED + "/" + installmentSecuredId, payload, paymentService.getUnzer().getPrivateKey())];
                case 1:
                    response = _a.sent();
                    installmentSecured = new InstallmentSecured_1.default();
...
//# sourceMappingURL=UpdateInstallmentSecured.js.map